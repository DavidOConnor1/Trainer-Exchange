...
This application is designed specifically for Pokémon card vendors, not general consumers. It streamlines the trading process at Pokémon card shows by allowing vendors to:
  ...
  Calculate trades based on vendor-set values, whether card-for-card or card-for-cash

  Manage and price their inventory within market value boundaries

  Search for card values using names or identifiers
