// components/user/UserCollections.js
"use client";
...
import { Plus, Trash2, FolderPlus, X, Package, DollarSign } from "lucide-react";
...
export default function UserCollections() {
  ...
  const handleCreateCollection = async () => {
    ...
    try {
      const description = newCollectionDescription.trim() || null;
